...
public class Player_Life : MonoBehaviour
{
    ...
    {
        SceneManager.LoadScene(SceneManager.GetActiveScene().name); // esto carga una escena, especificamente en la que estamos actualmente, es decir, este nivel, este metodo se activa dentro de la animacion de muerte
    }
}
